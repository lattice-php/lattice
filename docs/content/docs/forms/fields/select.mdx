...
The closure resolves the option, not its persistence — it returns whatever the tag should show right
away, and the consumer creates the underlying record. Lattice forms stay decoupled from the model.
