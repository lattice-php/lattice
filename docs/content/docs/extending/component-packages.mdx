...
behind, widens Playwright's timeout for CI runners, and keeps the browser's connections to the test
server alive (see [Browser tests](/testing/overview/#browser-tests)).
