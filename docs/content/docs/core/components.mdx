...
`Chart::make($title)` renders a data chart from rows of `->data()` and one or more line, bar, area, or
pie series. See the dedicated [Charts](/components/charts/) page for the full API and live examples.
