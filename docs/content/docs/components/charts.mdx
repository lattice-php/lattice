---
title: Charts
description: Data charts — line, bar, area, pie, doughnut, gauge, and distribution series from a single builder.
---
...
<ComponentExample
  php={`Chart::make('Revenue by channel', 'channel-distribution-chart')
    ->description('Share of total revenue')
    ->data([
