...
export declare function TimeGridView({ canReschedule, dayCount, from, locale, onDayClick, onEventClick, onNavigate, state, t, today, }: TimeGridViewProps): import("react").JSX.Element;
export {};
