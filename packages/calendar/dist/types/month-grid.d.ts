...
export declare function buildMonthGrid(monthISO: string, locale: string, todayISO: string): MonthGrid;
 ...
 */
export declare function weekChips(events: Iterable<CalendarEventData>, weekStart: string, dayCount?: number): {
    chips: MonthChip[];
    laneCount: number;
};
/**
 ...
 */
export declare function capLanes(chips: MonthChip[], maxVisibleLanes: number): {
    visible: MonthChip[];
    hiddenByDay: number[];
};
/** Every event occupying `date`, all-day spans first, then by start, then id. */
export declare function eventsOnDay(events: Iterable<CalendarEventData>, date: string): CalendarEventData[];
