...
import { RowActions } from "../rows/row-actions";
import { RowKeyInputs } from "../rows/row-key-inputs";
import { RowItem } from "../rows/row-item";
import { columnsFromSchema, TableRows } from "../rows/table-rows";
import { useFlipReorder } from "../rows/use-flip-reorder";
import { useRowCollection } from "../rows/use-row-collection";

const EMPTY_TEMPLATE: Node[] = [];

export const BuilderAdapter: RendererComponent<"field.builder"> = ({ node }) => {
