...
export type ComponentPropsOf<TType extends string> = ResolveProps<ComponentProps, Record<never, never>, TType, NodeProps>;
type LooseNode = {
    id?: string;
    key?: string;
    type: string;
...
export { clearRefreshedRefs, latestRef, LATTICE_REF_HEADER, storeRefreshedRef, withRefHeader, } from './component-ref.js';
export { LATTICE_EVENT } from './event-names.js';
export type { ReloadComponentEvent } from './event-names.js';
export { dataBindings, isRecord, materializeNode, materializeProps, materializeSchema, rowValue, } from './materialize.js';
export type { DataBindings, RemoteRow } from './materialize.js';
export { nodeKey, toNodes } from './nodes.js';
export { createRegistry, eagerComponent, extendRegistry, lazyComponent, loadPluginModules, } from './registry.js';
export type { ComponentRegistryFor, ExtensionRegistries, ExtensionRegistry, Plugin, PluginI18n, Registry, } from './registry.js';
export { RegistryContext, setDefaultRegistry, useComponentRegistry, useExtensionRegistry, } from './registry-context.js';
export { Renderer, RenderNode } from './renderer.js';
export { leafTestIdentity, nodeIdentity, prefixedNodeTestId, prefixedTestId, testIdentity, } from './test-id.js';
