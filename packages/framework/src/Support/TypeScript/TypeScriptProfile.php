...
{
    /**
     * Wire packages excluded from TypeScript generation: signature-example
     * hand-writes TypeScript that a generated.ts sibling would collide with,
     * and (though it has no such augmentation) trips the exhaustive
     ...
     * @var list<string>
     */
    public const array EMISSION_EXCLUDED = ['signature-example'];
