...
describe("table npm package contract", () => {
  ...
  it("is independently installable above Core, UI, and Form", () => {
    ...
    expect(manifest.name).toBe("@lattice-php/table");
    ...
    expect(aggregate.dependencies?.["@lattice-php/table"]).toBe(aggregate.version);
  });
