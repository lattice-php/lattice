...
export declare function BoardCardActions({ actions, cardId, columnKey, "data-test": testId, removeCard, restoreCard, }: BoardCardActionsProps): import("react").JSX.Element;
