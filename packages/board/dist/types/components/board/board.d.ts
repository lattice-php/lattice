...
export declare function Board({ cardAction, columns, componentRef, createAction, "data-test": testId, endpoint, filters, identity, moveAction, perColumn, query, queryKey, result, schema, searchable, syncQuery, }: BoardProps): import("react").JSX.Element;
