...
export declare function boardDragSource(data: Record<string | symbol, unknown>): BoardDragSource | null;
/** A card's own drop target: the top/bottom edge hitbox used to reorder next to it. */
export declare function boardCardDropTargetData(target: {
    cardId: string;
    columnKey: string;
}, args: {
    element: Element;
 ...
 */
export declare function boardDropTarget(dropTargets: readonly {
 ...
 */
export declare function computeBoardDropIntent(source: BoardDragSource, target: BoardDropTarget, order: Map<string, string[]>): BoardDropIntent | null;
