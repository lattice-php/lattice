...
export declare function blockDropTargetData(blockId: string, hit: {
    element: Element;
    input: Input;
}): Record<string | symbol, unknown>;
export declare function dropEdgeOf(data: DropTargetData): Edge | null;
/** A drop onto a slot's free area: appends to that slot. */
export declare function slotDropTargetData(parentId: string | null, slot: string | null): Record<string | symbol, unknown>;
 ...
 */
export declare function resolveDropTarget(document: BlockDocument, targets: readonly {
    data: DropTargetData;
}[], source: DragSource | null): BlockTarget | null;
export declare function dropAllowed(document: BlockDocument, types: readonly BlockTypeData[], source: DragSource, target: BlockTarget): boolean;
