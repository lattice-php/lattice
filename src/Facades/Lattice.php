 ...
 * @method static void pages(class-string<\Lattice\Lattice\Http\PageContract>|array<int, class-string<\Lattice\Lattice\Http\PageContract>> $pages)
 * @method static \Lattice\Lattice\Pages\PageRegistry pageRegistry()
