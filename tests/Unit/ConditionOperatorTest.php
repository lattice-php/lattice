...
it('evaluates operators', function (mixed $actual, ConditionOperator $op, mixed $expected, bool $result): void {
    ...
    'before' => ['2024-01-01', ConditionOperator::Before, '2024-06-01', true],
    'before miss' => ['2024-06-01', ConditionOperator::Before, '2024-01-01', false],
    'after' => ['2024-06-01', ConditionOperator::After, '2024-01-01', true],
    'after miss' => ['2024-01-01', ConditionOperator::After, '2024-06-01', false],
    'before unparseable' => ['not-a-date', ConditionOperator::Before, '2024-01-01', false],
