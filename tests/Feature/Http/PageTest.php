...
test('workbench pages serialize package component trees for inertia', function () {
    ...
    get('/')
        ...
        ->assertInertia(fn (AssertableInertia $page) => $page
            ...
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.0.schema.1.schema.1.props.label', 'Charts')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.0.schema.1.schema.1.props.href', '/charts')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.0.schema.1.schema.2.schema.2.props.label', 'Builder Table Demo')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.0.schema.1.schema.2.schema.2.props.href', '/builder-table')
            ...
            ->where('lattice.layout.schema.1.key', 'locale-switcher-panel')
            ->where('lattice.layout.schema.1.props.label', 'Language')
            ->where('lattice.layout.schema.1.props.placement', 'top-end')
            ->where('lattice.layout.schema.1.props.offset', 16)
            ->where('lattice.layout.schema.1.schema.0.type', 'action.group')
            ->where('lattice.layout.schema.1.schema.0.props.label', 'Language')
            ->where('lattice.layout.schema.1.schema.0.props.orientation', 'horizontal')
            ->where('lattice.layout.schema.1.schema.0.schema.0.type', 'action')
            ->where('lattice.layout.schema.1.schema.0.schema.0.key', 'locale-en')
            ->where('lattice.layout.schema.1.schema.0.schema.0.props.label', 'English')
            ->where('lattice.layout.schema.1.schema.0.schema.0.props.variant', 'secondary')
            ->where('lattice.layout.schema.1.schema.0.schema.1.key', 'locale-de')
            ->where('lattice.layout.schema.1.schema.0.schema.1.props.label', 'German')
            ->where('lattice.layout.schema.1.schema.0.schema.1.props.variant', 'ghost')
