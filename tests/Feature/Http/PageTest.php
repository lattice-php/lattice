...
test('workbench pages serialize package component trees for inertia', function () {
    ...
    get('/')
        ...
        ->assertInertia(fn (AssertableInertia $page) => $page
            ...
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.0.props.label', 'Language')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.type', 'action.group')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.props.label', 'Language')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.props.orientation', 'horizontal')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.schema.0.type', 'action')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.schema.0.key', 'locale-en')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.schema.0.props.label', 'English')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.schema.0.props.variant', 'secondary')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.schema.1.key', 'locale-de')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.schema.1.props.label', 'German')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.schema.1.props.variant', 'ghost')
