...
test('workbench pages serialize package component trees for inertia', function () {
    ...
    get('/')
        ...
        ->assertInertia(fn (AssertableInertia $page) => $page
            ...
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.type', 'action')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.key', 'locale-en')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.1.props.label', 'English')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.2.key', 'locale-de')
            ->where('lattice.layout.schema.0.schema.0.schema.0.schema.1.schema.2.props.label', 'German')
