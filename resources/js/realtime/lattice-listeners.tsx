...
const RealtimeListeners = lazy(() => import("./listeners"));
 ...
 */
export function LatticeListeners({ listeners }: { listeners?: ListenerPayload[] }) {
  ...
  return (
    <EchoBoundary>
      <Suspense fallback={null}>
        <RealtimeListeners listeners={listeners} />
      </Suspense>
    </EchoBoundary>
  );
}
