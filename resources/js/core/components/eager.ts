...
import type { CoreComponentType } from "./index";
...
} satisfies Record<CoreComponentType, ComponentRegistration>;

export const eagerCoreComponents = createPlugin({ components, name: "lattice/core" });
